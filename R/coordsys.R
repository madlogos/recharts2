...
setAxis = function(
    ...
    type = c('value', 'category', 'time', 'log'), offset = 0,
    ...
    o = list(
        ...
        boundaryGap = boundaryGap, min = min, max = max, scale = scale, offset = offset,
        splitNumber = splitNumber, interval = interval, logBase = logBase,
        triggerEvent = triggerEvent, silent = silent, axisLine = axisLine, axisTick = axisTick,
